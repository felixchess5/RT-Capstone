...
class SubjectOutputManager:
        ...
        self.subject_configs = {
            ...
            OutputSubject.SPANISH: SubjectOutput(
                ...
                specialized_fields=[
                    "grammar_accuracy",
                    "vocabulary_usage",
                    "fluency_communication",
                    "cultural_understanding",
                    "vocabulary_level",
                    "grammar_errors_count",
                    "cultural_references",
                    "verb_conjugations",
                    "assignment_type_spanish",
                ],
            ),
            ...
            OutputSubject.SCIENCE: SubjectOutput(
                ...
                specialized_fields=[
                    ...
                    "conclusion_validity",
                    "subject_area",
                    "assignment_type_science",
                    "scientific_method_completeness",
                    "units_measurements_count",
                    "formulas_identified_count",
                    "data_visualization_present",
                    "scientific_vocabulary_score",
                    "experimental_variables_identified",
                    "safety_considerations_count",
                ],
            ),
            OutputSubject.HISTORY: SubjectOutput(
                ...
                specialized_fields=[
                    "historical_accuracy",
                    "chronological_understanding",
                    "source_analysis",
                    "contextual_awareness",
                    "argument_development",
                    "historical_period",
                    "assignment_type_history",
                    "region_focus",
                    "dates_identified_count",
                    "historical_figures_count",
                    "events_mentioned_count",
                    "sources_cited_count",
                    "chronological_accuracy",
                    "historical_context_score",
                    "bias_awareness_score",
                    "historical_vocabulary_score",
    ...
    def determine_subject(self, assignment_data: Dict) -> OutputSubject:
        ...
        if "assignment_classification" in assignment_data:
            subject_name = (
                assignment_data["assignment_classification"]
                .get("subject", "general")
                .lower()
            )
        elif "specialized_processing" in assignment_data:
            subject_name = (
                assignment_data["specialized_processing"]
                .get("classification", {})
                .get("subject", "general")
                .lower()
            )
    ...
    def extract_specialized_data(
        self, assignment_data: Dict, subject: OutputSubject
    ) -> Dict:
                ...
                if subject == OutputSubject.MATHEMATICS:
                    ...
                    if "grading" in processing_results:
                        ...
                        specialized_data.update(
                            {
                                "mathematical_accuracy": grading.get(
                                    "mathematical_accuracy", 0
                                ),
                                "problem_solving_approach": grading.get(
                                    "problem_solving_approach", 0
                                ),
                                "notation_clarity": grading.get("notation_clarity", 0),
                                "step_by_step_work": grading.get(
                                    "step_by_step_work", 0
                                ),
                            }
                        )
                    ...
                    if "analysis" in processing_results:
                        ...
                        specialized_data.update(
                            {
                                "equations_solved": len(
                                    analysis.get("equations_found", [])
                                ),
                                "problem_types": ", ".join(
                                    analysis.get("problem_types", [])
                                ),
                                "step_by_step_present": analysis.get(
                        ...
                        specialized_data.update(
                            {
                                ...
                                "fluency_communication": grading.get(
                                    "fluency_communication", 0
                                ),
                                "cultural_understanding": grading.get(
                    ...
                    if "analysis" in processing_results:
                        ...
                        specialized_data.update(
                            {
                                "vocabulary_level": analysis.get(
                                    "vocabulary_level", "unknown"
                                ),
                                "grammar_errors_count": analysis.get(
                                    "grammar_errors_count", 0
                                ),
                                "cultural_references_count": analysis.get(
                                    "cultural_references_count", 0
                                ),
                                "assignment_type_spanish": analysis.get(
                    ...
                    if "grading" in processing_results:
                        ...
                        specialized_data.update(
                            {
                                "scientific_accuracy": grading.get(
                                    "scientific_accuracy", 0
                                ),
                                "hypothesis_quality": grading.get(
                                    "hypothesis_quality", 0
                                ),
                                "data_analysis": grading.get("data_analysis", 0),
                                "experimental_design": grading.get(
                                    "experimental_design", 0
                                ),
                                "conclusion_validity": grading.get(
                        ...
                        specialized_data.update(
                            {
                                ...
                                "assignment_type_science": analysis.get(
                                    "assignment_type", "unknown"
                                ),
                                "scientific_method_completeness": analysis.get(
                                    "scientific_method_elements", {}
                                ).get("completeness_percentage", 0),
                                "units_measurements_count": analysis.get(
                                    "units_and_measurements_count", 0
                                ),
                                "formulas_identified_count": analysis.get(
                                    "formulas_identified_count", 0
                                ),
                                "data_visualization_present": analysis.get(
                                    "data_visualization_present", False
                                ),
                                "scientific_vocabulary_score": analysis.get(
                                    "scientific_vocabulary_score", 0
                                ),
                                "experimental_variables_identified": len(
                                    analysis.get("experimental_variables", {}).get(
                                        "independent", []
                                    )
                                )
                                + len(
                                ...
                                "safety_considerations_count": analysis.get(
                                    "safety_considerations_count", 0
                                ),
                            }
                        )
                    ...
                    if "grading" in processing_results:
                        ...
                        specialized_data.update(
                            {
                                "historical_accuracy": grading.get(
                                    "historical_accuracy", 0
                                ),
                                "chronological_understanding": grading.get(
                                    "chronological_understanding", 0
                                ),
                                "source_analysis": grading.get("source_analysis", 0),
                                "contextual_awareness": grading.get(
                                    "contextual_awareness", 0
                                ),
                                "argument_development": grading.get(
                                    "argument_development", 0
                                ),
                            }
                        )
                        ...
                        specialized_data.update(
                            {
                                ...
                                "assignment_type_history": analysis.get(
                                    "assignment_type", "unknown"
                                ),
                                "region_focus": analysis.get("region_focus", "unknown"),
                                "dates_identified_count": analysis.get(
                                    "dates_identified_count", 0
                                ),
                                "historical_figures_count": analysis.get(
                                    "historical_figures_count", 0
                                ),
                                "events_mentioned_count": analysis.get(
                                    "events_mentioned_count", 0
                                ),
                                "sources_cited_count": analysis.get(
                                    "sources_cited_count", 0
                                ),
                                "chronological_accuracy": analysis.get(
                                    "chronological_accuracy", 0
                                ),
                                "historical_context_score": analysis.get(
                                    "historical_context_score", 0
                                ),
                                "bias_awareness_score": analysis.get(
                                    "bias_awareness_score", 0
                                ),
                                "historical_vocabulary_score": analysis.get(
                                    "historical_vocabulary_score", 0
                                ),
                                "evidence_usage_score": analysis.get(
    ...
    def export_subject_csv(
        self, assignments: List[Dict], subject: OutputSubject
    ) -> str:
        ...
        with open(csv_path, "w", newline="", encoding="utf-8") as f:
            ...
            for assignment in subject_assignments:
                ...
                row_data = {
                    ...
                    "date_of_submission": assignment.get(
                        "date_of_submission", "Unknown"
                    ),
                    ...
                    "summary": (
                        assignment.get("summary", "No summary available")[:200] + "..."
                        if len(str(assignment.get("summary", ""))) > 200
                        else assignment.get("summary", "No summary available")
                    ),
                }
                ...
                filtered_row_data = {
                    field: row_data.get(field, "N/A") for field in all_fields
                }

                writer.writerow(filtered_row_data)

        print(
            f"✅ Exported {len(subject_assignments)} {subject.value} assignments to {csv_path}"
        )
        return csv_path

    def export_subject_json(
        self, assignments: List[Dict], subject: OutputSubject
    ) -> str:
        ...
        print(
            f"✅ Exported {len(subject_assignments)} {subject.value} assignments to {json_path}"
        )
        return json_path
    ...
    def create_export_summary(self, subject_groups: Dict, export_results: Dict):
        ...
        with open(summary_path, "w", encoding="utf-8") as f:
            ...
            total_assignments = sum(
                len(assignments) for assignments in subject_groups.values()
            )
...
def create_subject_output_manager(
    output_folder: str = "./output",
) -> SubjectOutputManager:
